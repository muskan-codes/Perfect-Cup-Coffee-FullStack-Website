<?php
//Initialize session which helps in showing if the user is not logged in it will close the blog
session_start();
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12 text-center">
                    ...
                    <p>Take the edge off with a Fresh hot cup of coffee made Irish whiskey and Irish Cream.</p>
